...
class ApiBasicAuthorization {
  final String baseUrl = ApiBasicAuthorizationConstant.baseUrl;
  final String username = ApiBasicAuthorizationConstant.username;
  final String password = ApiBasicAuthorizationConstant.password;
  ...
  Future<Map<String, dynamic>> get(String endpoint) async {
    try {
      ...
      var response = await Requests.get(url.toString(),headers:  _headers(),timeoutSeconds: 10);
  ...
  Future<Map<String, dynamic>> delete(String endpoint) async {
    ...
    var url = Uri.parse(baseUrl + endpoint);
    var response = await Requests.delete(url.toString(),headers:  _headers(),timeoutSeconds: 10);
  ...
  Map<String, dynamic> _response(http.Response response) {
    ...
    if (statusCode >= 200 && statusCode < 300) {
      ...
      throw Exception(AppLocalization.instance.translate(
          'lib.utils.service.webApi.apiBasicAuthorization',
          '_response',
          'ExceptionMessage'));
    }
  }
...
/* // API'ye erişmek için yardımcı sınıfı oluşturun ve temel kimlik doğrulama bilgilerinizi ilettiğinizden emin olun
ApiHelper api = ApiHelper(username: "your_username_here", password: "your_password_here");
